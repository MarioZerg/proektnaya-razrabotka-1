...
export const workshopSettingsConfig: SettingConfigItem[] = [
  ...
  // Швея держит в работе несколько вещей, и ширина у них часто одинаковая — таймеры по
  // ширине кончаются в одну секунду, вещи сдаются пачкой, и стикеровка получает рывок.
  // Каждой следующей вещи «на руках» добавляем этот сдвиг: вторая сдаётся на 5 минут
  // позже первой, третья — на 10. 0 — сдвиг выключен.
  {
    key: 'sewing_stagger_minutes',
    label: 'Сдвиг сдачи каждой следующей вещи у швеи, мин',
    type: 'number',
  },
  {
