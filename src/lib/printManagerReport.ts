...
<div style="width:794px;height:1123px;padding:56px 64px;box-sizing:border-box;
  ...
  <div style="margin-top:36px;padding:16px;background:#f8f8f8;font-size:13px;
    ...
    Начисление проверяется 15 дней: если покупатель возвращает товар в этот
    срок, соответствующая доля удерживается. Возвраты после окончания проверки
    на выплату не влияют.<br />
