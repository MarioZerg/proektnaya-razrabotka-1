...
/**
 * Хронология по двум периодам. Разделение принципиально: чеки, приложенные
 * заявительницей к обращению, закрывают ПЕРВЫЙ период, а спор идёт про второй.
 */
const TIMELINE = [
  {
        ...
        <section className="space-y-3">
          ...
          <Card>
            <CardContent className="space-y-3 p-5 text-sm leading-relaxed">
              <p>
                <b>Два разных периода, а не один.</b> Чеки, приложенные заявительницей к
                обращению, закрывают первый период (июнь — 29.07.2026): по нему выплачено
              ...
              <p>
                ...
                ИНН и СНИЛС → подписание договора ГПХ и акта → выплата. Проект договора
                готов, замечания по условиям готовы обсуждать.
              </p>
            </CardContent>
          </Card>
        </section>
