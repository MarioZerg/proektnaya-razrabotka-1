...
const steps: Step[] = [
  ...
  },
  {
    ...
    text: 'В списке «Отобрано к подбору» видно, какой размер нужен и на какой полке он лежит. Берите любую вещь этого размера — они одинаковые.',
  ...
  },
  {
    ...
    text: 'Наведите сканер на стикер хранения. Номер стикера искать не нужно: подходит любая вещь нужного материала и размера. Сканер сам посчитает количество — сколько штук в подборе, столько раз и ответит «нужная», а лишние отсекает.',
  },
  {
    num: 5,
