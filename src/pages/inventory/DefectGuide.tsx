...
const defectSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'На терминале откройте «Приём брака из цеха» и сканируйте стикер на каждом куске. Система покажет материал, метраж, причину и кто нашёл. Внизу экрана видно, сколько ещё не принято.',
    image: IMG_SCAN,
  },
  {
    num: 4,
  ...
  {
    num: 5,
    title: 'Решите судьбу материала',
    text: 'Принятый брак складывайте отдельно. Дальше — либо утилизация, либо возврат поставщику, если брак заводской. Подробнее ниже.',
    image: IMG_DECIDE,
  },
];

/** Что делать с принятым браком дальше. */
const outcomes = [
  {
    icon: 'Undo2',
    ...
    text: 'Заводской брак: дырки, полосы по всему полотну, брак утяжелителя, бракованная тесьма из рулона. Такое поставщик обязан заменить.',
  ...
  },
  {
    ...
    text: 'Мелкие куски, обрезки, испорченная упаковка и всё, что поставщик не примет обратно. Метры уже списаны — просто выбрасываем.',
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: 'Откройте «Анализ брака» — там видно, по каким материалам и у кого чаще всего брак. С этим уже идут к руководителю.',
  },
];
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Заводской брак поставщик меняет, остальное утилизируем
            </p>
          </div>
