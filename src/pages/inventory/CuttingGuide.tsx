...
const cuttingRules = [
  ...
  {
    num: 3,
    title: 'Сверьте боковые края',
    text: 'Приложите боковые края тюля друг к другу и проверьте, что они совпадают. Если полотно «ушло» и края не сходятся — рвать по нити нельзя, изделие получится косым.',
  },
  {
    num: 4,
    title: 'Края не совпали — режьте ножницами',
    text: 'Размечайте линию реза рулеткой по всему полотну через каждые 70 см и режьте ножницами по этим отметкам. Только так линия получится ровной на всей ширине.',
    accent: 'отметки каждые 70 см',
  },
  {
    num: 5,
  ...
  },
  {
    ...
    text: 'Сделайте надрез и оторвите ткань. Оставшийся кусок по высоте просто утилизируйте — оформлять его как брак не нужно, это обычный технологический отход.',
  },
];
...
const faq = [
  ...
  {
    q: 'Боковые края тюля не совпадают',
    a: 'Значит полотно перекошено — рвать по нити нельзя, изделие выйдет косым. Отмерьте высоту рулеткой по всей ширине полотна, ставя отметки каждые 70 см, и режьте ножницами по этой линии.',
  },
  {
    q: 'Куда девать обрезок по высоте',
    a: 'Просто в мусор. Это технологический отход от нормального раскроя, а не брак — на терминале его оформлять не нужно. Брак из рулона оформляется только тогда, когда ткань испорчена: дырки, полосы, затяжки, пятна.',
  },
];
