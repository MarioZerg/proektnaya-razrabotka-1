...
const returnSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'На складе товара нажмите «Привёз с пункта выдачи» и сканируйте пакеты. Система покажет, что это за товар, размеры и причину возврата, и заведёт вещь на склад.',
    where: 'Инвентаризация → Склад товара',
  ...
  },
  {
    ...
    text: 'Нажмите «Разобрать возвраты». По каждой вещи выберите: годная — сразу на полку (укажите полку, и товар станет доступен для заказов), мятая или с дефектом — в цех на осмотр.',
    where: 'Инвентаризация → Склад товара',
    path: '/crm/inventory/returns-inspection',
  },
  {
    num: 5,
...
const faq = [
  {
    ...
    a: 'Значит администратор ещё не одобрил этот возврат. Отложите пакет и скажите ему — как только одобрит, вещь отсканируется.',
  },
  {
