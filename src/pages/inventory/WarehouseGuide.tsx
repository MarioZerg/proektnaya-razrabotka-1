...
const returnSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'Откройте «Приём возвратов». Вверху страницы поле для сканирования: сканируйте пакет с товаром. Система покажет, что это за товар, размеры и причину возврата.',
    where: 'Отгрузки → Приём возвратов',
