...
const returnSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'Откройте «Приём возвратов». Вверху страницы поле для сканирования: наведите сканер на стикер возврата на коробке. Система покажет, что это за товар, размеры и причину возврата.',
