...
const steps: Step[] = [
  ...
  },
  {
    ...
    text: 'Создайте поставку на нужный склад и соберите товар. Отгрузить получится только когда собрано всё количество по заявке — недособранную поставку система не выпустит и покажет, сколько не хватает.',
...
const faq = [
  ...
  {
    q: 'Можно отгрузить поставку не полностью',
    a: 'Нет. Система не выпустит поставку FBO, пока не собрано всё количество по заявке — напишет, сколько собрано из скольки. Либо дособерите товар, либо уменьшите количество в заявке.',
  },
];
