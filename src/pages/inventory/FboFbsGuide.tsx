...
const faq = [
  ...
  {
    q: 'Вещь FBO попала в контейнер FBS',
    a: 'Найдите её и переложите. Пока вещь лежит в чужом контейнере, при сборке поставки система её не увидит, и товар не уедет на склад.',
  },
  {
          ...
          <CardContent className="flex items-start gap-3 py-4">
            ...
            <div>
              ...
              <p className="text-sm text-violet-900">
                ...
                Смешивать их в контейнерах нельзя: FBO собирается в поставку по городам,
                и вещь из чужого контейнера система при сборке не найдёт.
              </p>
            </div>
          </CardContent>
        </Card>
