...
const packSteps: Step[] = [
  ...
  },
  {
    ...
    text: 'Заказы Яндекс Маркета не смешиваем с OZON и Wildberries. Они идут связкой: на терминале видно «Связка 1 из 2» — дождитесь все вещи заказа и упакуйте вместе. Если связки на заказе Яндекса нет, такой заказ идёт в общий контейнер.',
    image: IMG_SORT,
  },
  {
    num: 5,
...
const faq = [
  ...
  },
  {
    ...
    a: 'Дождитесь остальные. На терминале видно «Связка 1 из 2» — заказ уходит одним ярлыком, отправить половину нельзя.',
  },
  {
