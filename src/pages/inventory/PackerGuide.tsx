...
const containers = [
  ...
  },
  {
    ...
    text: 'Товар едет на склад маркетплейса. Город написан на стикере — только там, в системе одинаковые изделия разных городов не различаются. Для каждого города свой контейнер: Хоругвино к Хоругвино, Казань к Казани.',
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: 'На стикере FBO написан кластер — это и есть склад, куда уедет товар. Он же показан на терминале после сканирования, в строке «Город назначения». Проверяйте глазами: у одинаковых изделий разных городов артикул совпадает, и система подмену не заметит.',
  },
  {
        ...
        <div className="space-y-3">
          ...
          <Card className="border-destructive/40 bg-destructive/5 shadow-none">
            <CardContent className="flex items-start gap-3 py-4">
              <Icon name="TriangleAlert" size={22} className="mt-0.5 shrink-0 text-destructive" />
              <div>
                <p className="font-bold text-destructive">Читайте город на стикере</p>
                <p className="text-sm text-destructive">
                  У одинаковых изделий из разных городов артикул совпадает: вуаль 200×250
                  для Хоругвино и для другого кластера — один и тот же товар. Система город
                  не проверяет, он написан только на стикере. Прочитайте название кластера
                  и положите вещь в коробку этого города.
                </p>
                <p className="mt-2 text-sm text-destructive">
                  Перепутали — товар правильный, но покупатель получит стикер чужого города.
                  Терминал после стикеровки пишет нужный контейнер — смотрите на него.
                </p>
              </div>
            </CardContent>
          </Card>
