...
const steps: Step[] = [
  ...
  {
    num: 4,
    title: 'Не согласны — идите к руководителю',
    text: 'Если удержание считаете несправедливым (сломался терминал, вас задержали по работе), скажите руководителю. Он проверит и может отменить.',
  },
];
...
const faq = [
  ...
  {
    q: 'Опоздал, потому что не работал терминал',
    a: 'Сразу скажите руководителю. Система этого знать не может, но администратор вправе отменить удержание.',
  },
  {
    q: 'Забыл закрыть смену — что теперь',
    a: 'Ночью система закроет её сама и начислит удержание. Заведите привычку закрывать смену перед уходом — это одна кнопка на терминале.',
  },
  {
  ...
  },
  {
    ...
    a: 'Автоматических — нет. Брак фиксируется поимённо, и по нему видно статистику, но удержание руководитель назначает вручную и только разобравшись.',
  },
];
          ...
          <CardContent className="flex items-start gap-3 py-4">
            ...
            <div>
              ...
              <p className="text-sm text-violet-900">
                ...
                нет. Считаете несправедливым — скажите руководителю.
              </p>
            </div>
          </CardContent>
        </Card>
