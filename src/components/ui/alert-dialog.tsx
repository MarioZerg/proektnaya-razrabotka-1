...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // На телефоне окно раньше уходило за край экрана: ширина бралась во весь
        // экран без полей по бокам. Оставляем отступы и ограничиваем высоту, чтобы
        // длинный текст подтверждения прокручивался, а кнопки были доступны.
