 ...
 *
 * Было 3 секунды — это 1200 обращений к серверу за смену на КАЖДЫЙ открытый чат,
 * и каждое оплачивается по минимальному тарифу, даже если новых сообщений нет.
 * Чат в цехе — это переписка людей, а не биржевые котировки: задержка в 8 секунд
 * незаметна на глаз, зато обращений становится втрое меньше.
 */
