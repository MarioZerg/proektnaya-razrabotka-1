  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-slate-900 text-primary-foreground shadow-lg transition-transform hover:scale-105"
      >
