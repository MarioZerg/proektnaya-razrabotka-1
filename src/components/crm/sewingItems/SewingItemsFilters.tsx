...
interface SewingItemsFiltersProps {
  ...
  /** Показывать выбор сотрудника. Швее его не показываем: её вкладки и так
   * отфильтрованы по ней самой, а выбор чужого имени ничего бы не дал — только
   * создавал ощущение, что она видит и может взять чужую работу. */
