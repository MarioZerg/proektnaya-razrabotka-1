      ...
      <CardContent className="flex flex-wrap items-end gap-3">
        ...
        {sewWaitSec > 0 && (
          <p className="text-xs text-muted-foreground">
            Время на пошив этой вещи задано настройками цеха по её ширине. У второй
            вещи, взятой поверх первой, оно чуть больше — чтобы обе не сдавались
            в одну минуту. Кнопка откроется сама.
          </p>
        )}
      </CardContent>
    </Card>
