 ...
 *
 * Кладовщик пикает наклейку на коробке, и вещь сразу встаёт на склад. Выбирать
 * галочками из списка не нужно: раньше он держал коробку в руках и всё равно искал
 * её в перечне из полусотни позиций — долго и легко отметить не ту.
 *
 * Возврат ищется у самого маркетплейса, поэтому принимается любая коробка — даже та,
 * которой ещё не было в нашем списке.
 *
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Сканируйте наклейки на коробках одну за другой. Каждая вещь сразу встаёт
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder={busy ? 'Принимаем...' : 'Отсканируйте наклейку'}
