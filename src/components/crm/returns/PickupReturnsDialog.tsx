      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            ...
            Маркет. Подойдёт наклейка возврата, стикер WB или клиентский стикер с
            номером отправления. Каждая вещь сразу встаёт на склад: дальше разберёте,
            в цех на осмотр или на полку.
          </p>
