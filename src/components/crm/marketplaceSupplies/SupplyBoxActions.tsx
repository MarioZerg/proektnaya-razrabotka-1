  ...
  <>
    ...
    {box.stickerUrl && (
      <div className="space-y-1.5">
        {/* Стикер короба от маркетплейса печатаем на стандартной наклейке 120×75 — той же,
            что у WB и упаковочных листов: на складе один рулон под все ярлыки.
        ...
        >
          <Icon
            ...
            className={`mr-1.5 ${printing ? 'animate-spin' : ''}`}
          />
          {printing ? 'Готовим стикер…' : 'Печать стикера короба (120×75)'}
        </Button>
        <a
          href={box.stickerUrl}
          target="_blank"
