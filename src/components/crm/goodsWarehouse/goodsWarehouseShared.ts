 ...
 * полке и сканируют. Для утерянной вещи он бессмыслен — её на складе нет, и
 * печать плодила бы штрихкоды, за которыми ничего не стоит.
 *
 * ОТГРУЖЕННЫМ ПЕЧАТЬ РАЗРЕШЕНА, и это не оплошность.
 *
 * Статус «Отгружен» проставляется всем вещам поставки разом при её закрытии.
 * Но вещь запросто может остаться у нас: её вынули из короба, вернули с приёмки
 * площадки, заказ отменили уже после закрытия поставки. Тогда по системе она
 * «уехала», а физически лежит на столе у кладовщика.
 *
 * Раньше в такой ситуации был тупик: терминал сборки называл штрихкод хранения,
 * кладовщик шёл на склад — а кнопка печати скрыта, потому что вещь отгружена.
