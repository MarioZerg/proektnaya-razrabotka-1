 ...
 *   4. Осмотрено — упаковщица закончила и наклеила стикер хранения;
 *   5. Забрано с производства — кладовщик забрал вещи, полка ещё не назначена;
 *   6. На утилизацию / Утилизировано — брак.
 */
export const INSPECTION_STAGES: {
  ...
  },
  {
    key: 'inspected',
    title: 'Осмотрено',
    hint: 'Со стикером хранения, ждут кладовщика',
    icon: 'CircleCheck',
    tone: 'success',
  },
  {
    key: 'taken',
    title: 'Забрано с производства',
