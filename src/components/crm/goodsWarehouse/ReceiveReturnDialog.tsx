  ...
  const handleScan = async () => {
    ...
    try {
      ...
      try {
        ...
        // Возврата нет в нашей базе — возможно, пакет только что выдали в пункте
      ...
      <DialogContent className="max-w-2xl">
        ...
        {found ? (
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_auto]">
            ...
            {/* Два пути вещи. Основной — сразу упаковщице: кладовщик пикнул пакет и
          ...
          >
            <div className="rounded-md border border-border bg-muted/40 p-3">
              <p className="text-sm text-muted-foreground">
                Сканируйте пакет с товаром: наклейку возврата (код вида «ii15847049514») или
