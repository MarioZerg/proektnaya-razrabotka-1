...
export const accrualTypeLabels: Record<string, string> = {
  ...
  penalty: 'Штраф',
  /** Удержание без вины: спецодежда, выкуп товара, аванс. Не наказание. */
  deduction: 'Удержание',
  /**
   * Возврат отменённого штрафа.
   *
   * Выплаченный штраф удалить нельзя — деньги уже удержаны, и стирание строки
   * развалило бы расчётный лист. Поэтому отмена возвращает сумму отдельным
   * начислением: видно и наказание, и его отмену, и кто её сделал.
   */
  penalty_refund: 'Возврат штрафа',
