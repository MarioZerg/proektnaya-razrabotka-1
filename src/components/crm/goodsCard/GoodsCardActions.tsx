          ...
          {alreadyInSupply ? (
            ...
            <>
              ...
              {/* Оба «плохих» исхода по вещи — в одном меню.
                  ...
                  МЕНЮ ЕСТЬ ТОЛЬКО У ВЕЩИ, ПОДОБРАННОЙ ПОД ЗАКАЗ.
                  Оба действия списывают вещь и отправляют ЗАКАЗ шиться заново.
                  У свободной вещи на полке заказа нет: списание уничтожило бы
                  товар без всякой замены, а остаток разошёлся бы с полкой.
                  Брак свободной вещи оформляется утилизацией. */}
              {!!card.reservedOrderId && (
