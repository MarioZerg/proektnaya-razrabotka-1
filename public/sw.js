...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      // cache: 'reload' — заглавную страницу берём строго с сервера, минуя кэш
      // браузера. Иначе планшет в цехе может сутками открывать сохранённую копию
      // страницы со ссылками на старые файлы сборки: система обновилась, а на
      // терминале продолжает работать прошлая версия.
